        ...
        <div className={styles.goodsInfo}>
          ...
          <div className={styles.infoRight}>
            ...
            <div className={styles.activeTime}>
              <div className={styles.time}><span className={styles.timeTxt}>距结束仅剩</span><span className={styles.timeNum}>06:35:22</span></div>
            ...
            <div className={styles.activeOpr}>
              <div className={styles.priceStore}>
                ...
                <span className={styles.oldPrice}>¥ 8699</span>
              </div>
